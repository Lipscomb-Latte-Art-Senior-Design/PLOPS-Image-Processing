...
left_eye = (-7, -6)  # (x,y)
right_eye = (8, -6)  # (x,y)
smile_center = (1, -15)  # (x,y)
circle_center = (1, -15)  # (x,y)
...
commands += generate_priming((-40, 30, 100), prime_dist=primeDist, travel_vel=travel_vel, draw_vel=draw_vel)
...
commands += generate_arc(center=circle_center, radius=circle_radius, arc=(0, 360), angular_resolution=10, extrusion_per_mm=1, cummulative_extrusion=cummulative_extrusion)
cummulative_extrusion = commands[len(commands)-1][3]

# generate arc for smile
commands += generate_arc(center=smile_center, radius=smile_radius, arc=smile_arc, angular_resolution=10, extrusion_per_mm=1, cummulative_extrusion=cummulative_extrusion)
cummulative_extrusion = commands[len(commands)-1][3]
